import {r as c, j as e, L as a} from "./index-CWbBFHrl.js";
function x() {
    const [i,l] = c.useState("local")
      , r = [{
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsx("section", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsx("div", {
                    className: "bg-teal-700 py-16 sm:py-20 md:py-24 lg:py-32 px-6 sm:px-8 md:px-12 flex items-center",
                    children: e.jsxs("div", {
                        className: "max-w-xl",
                        children: [e.jsx("h1", {
                            ...
                            className: "text-lg sm:text-xl md:text-2xl text-teal-100 mb-8 sm:mb-10 md:mb-12 leading-relaxed",
                            children: "There are many ways to make a difference. Whether you volunteer your time, raise funds, or participate in events, your contribution transforms lives."
                        }), e.jsxs("div", {
                    ...
                    className: "relative h-[500px] sm:h-[600px] lg:h-auto lg:min-h-[600px] bg-gray-100",
                    children: e.jsxs("div", {
                        className: "absolute inset-0 grid grid-cols-2 gap-2 p-2 sm:p-4",
                        children: [e.jsx("img", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("h2", {
                        ...
                        children: "Join our team of dedicated volunteers making a real difference in children's lives"
                    })]
                }), e.jsx("div", {
                    ...
                    children: e.jsxs("div", {
                        ...
                        children: [e.jsx("button", {
                            onClick: () => l("local"),
                            className: `flex-1 px-4 sm:px-8 py-2.5 sm:py-3 rounded-full text-sm sm:text-base font-semibold transition-all duration-300 whitespace-nowrap cursor-pointer ${i === "local" ? "bg-teal-600 text-white shadow-lg" : "text-gray-600 hover:text-gray-900"}`,
                            children: "Local Volunteers"
                        }), e.jsx("button", {
                            onClick: () => l("international"),
                            className: `flex-1 px-4 sm:px-8 py-2.5 sm:py-3 rounded-full text-sm sm:text-base font-semibold transition-all duration-300 whitespace-nowrap cursor-pointer ${i === "international" ? "bg-teal-600 text-white shadow-lg" : "text-gray-600 hover:text-gray-900"}`,
                            children: "International"
                        })]
                    })
                }), e.jsx("div", {
                    className: "grid md:grid-cols-2 gap-6 sm:gap-8",
                    children: (i === "local" ? r : n).map( (t, s) => e.jsx("div", {
                        ...
                        children: e.jsxs("div", {
                            ...
                            children: [e.jsx("div", {
                                className: "w-12 h-12 sm:w-16 sm:h-16 bg-teal-600 rounded-xl flex items-center justify-center flex-shrink-0",
                                children: e.jsx("i", {
                                ...
                                children: [e.jsx("h3", {
                                    ...
                                    children: [e.jsxs("span", {
                                        className: "px-3 sm:px-4 py-1.5 sm:py-2 bg-amber-100 text-amber-700 rounded-full text-xs sm:text-sm font-medium",
                                        children: [e.jsx("i", {
                                            className: "ri-time-line mr-1"
                                        }), t.commitment]
                                    }), e.jsxs("span", {
                                        className: "px-3 sm:px-4 py-1.5 sm:py-2 bg-teal-100 text-teal-700 rounded-full text-xs sm:text-sm font-medium",
                                        children: [e.jsx("i", {
                                            className: "ri-map-pin-line mr-1"
                                        }), t.location]
                                    })]
                                }), e.jsxs(a, {
                                    to: "/contact",
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("h2", {
                        className: "text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6",
                        children: "Start Your Fundraising Campaign"
                    }), e.jsx("p", {
                        className: "text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto",
                        children: "Create your own fundraising page and rally your network to support education in Uganda"
                    })]
                }), e.jsx("div", {
                    className: "space-y-10 sm:space-y-16",
                    children: o.map( (t, s) => e.jsxs("div", {
                        className: `flex flex-col sm:flex-row items-center gap-6 sm:gap-12 ${s % 2 === 1 ? "sm:flex-row-reverse" : ""}`,
                        children: [e.jsx("div", {
                            className: "flex-shrink-0",
                            children: e.jsx("div", {
                                className: "w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-teal-600 to-teal-700 rounded-full flex items-center justify-center shadow-2xl",
                                children: e.jsx("span", {
                            ...
                            className: "flex-1 bg-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-lg w-full",
                            children: e.jsxs("div", {
                                className: "flex items-start gap-3 sm:gap-4",
                                children: [e.jsx("div", {
                                    className: "w-10 h-10 sm:w-12 sm:h-12 bg-amber-100 rounded-lg flex items-center justify-center flex-shrink-0",
                                    children: e.jsx("i", {
                                        className: `${t.icon} text-xl sm:text-2xl text-amber-600`
                                    })
                                }), e.jsxs("div", {
                                    children: [e.jsx("h3", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("h2", {
                        ...
                        className: "text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto",
                        children: "Join us at our events and be part of the change"
                    })]
                }), e.jsx("div", {
                    className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8",
                    children: m.map( (t, s) => e.jsx("div", {
                        ...
                        children: e.jsxs("div", {
                            className: "flex",
                            children: [e.jsxs("div", {
                                className: "w-20 sm:w-24 bg-teal-700 flex flex-col items-center justify-center p-3 sm:p-4 flex-shrink-0",
                                children: [e.jsx("div", {
                                    className: "text-3xl sm:text-4xl font-bold text-white",
                                    children: t.date.day
                                }), e.jsx("div", {
                                    className: "text-xs sm:text-sm uppercase text-teal-200",
                                    children: t.date.month
                                })]
                            }), e.jsxs("div", {
                                className: "flex-1 p-4 sm:p-6",
                                children: [e.jsx("div", {
                                    className: "inline-block px-2.5 sm:px-3 py-1 bg-amber-100 text-amber-700 text-xs font-semibold rounded-full mb-2 sm:mb-3",
                                    children: t.type
                                }), e.jsx("h3", {
                                    className: "text-lg sm:text-xl font-bold text-gray-900 mb-2",
                                    children: t.title
                                }), e.jsxs("div", {
                                    className: "space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-600",
                                    children: [e.jsxs("div", {
                                        className: "flex items-center gap-2",
                                        children: [e.jsx("i", {
                                            className: "ri-time-line text-teal-600"
                                        }), e.jsx("span", {
                                            children: t.time
                                        })]
                                    }), e.jsxs("div", {
                                        className: "flex items-center gap-2",
                                        children: [e.jsx("i", {
                                            className: "ri-map-pin-line text-teal-600"
                                        }), e.jsx("span", {
                                            children: t.location
                                        })]
                                    })]
            ...
            className: "py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-teal-700 to-teal-800",
            children: e.jsxs("div", {
                ...
                children: [e.jsx("h2", {
                    ...
                    children: "Every action counts. Whether you volunteer, fundraise, or attend events, you're helping transform lives through education."
                }), e.jsxs("div", {
...
export {x as default};
//# sourceMappingURL=page-CVf-6zH1.js.map
