import {r as m, j as e, L as t} from "./index-CWbBFHrl.js";
function d() {
    const [o,c] = m.useState("overview")
      , l = [{
        icon: "ri-money-dollar-circle-line",
        title: "School Fees",
        items: ["Full tuition coverage for primary and secondary education", "Exam registration fees", "School development funds", "Parent-teacher association contributions"],
        impact: "Over 2,000 children currently enrolled in school"
    }, {
        icon: "ri-book-2-line",
        title: "Scholastic Materials",
        items: ["Textbooks and exercise books", "Pens, pencils, and writing materials", "Mathematical instruments and calculators", "Art supplies and science materials"],
        impact: "15,000+ books distributed annually"
    }, {
        icon: "ri-shirt-line",
        title: "School Uniforms",
        items: ["Complete uniform sets (shirts, trousers/skirts)", "School shoes and socks", "Sports uniforms for physical education", "Seasonal replacements as children grow"],
        impact: "3,500+ uniforms provided each year"
    }, {
        icon: "ri-heart-pulse-line",
        title: "Sanitary Support",
        items: ["Monthly sanitary pad supplies for girls", "Hygiene education and workshops", "Reusable sanitary products", "Private changing facilities advocacy"],
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsxs("section", {
            className: "relative h-[400px] sm:h-[500px] flex items-center",
            children: [e.jsxs("div", {
                ...
                children: e.jsxs("div", {
                    ...
                    children: [e.jsxs("div", {
                        ...
                        className: "text-xl sm:text-2xl md:text-3xl text-white/90 font-light",
                        children: "Building Futures, One Child at a Time"
                    })]
                })
            })]
        }), e.jsx("section", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("div", {
                        className: "inline-block px-4 sm:px-6 py-2 bg-teal-600 text-white text-sm sm:text-base font-semibold rounded-full mb-4 sm:mb-6",
                        children: "Core Program"
                    }), e.jsx("h2", {
                        className: "text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6",
                        children: "Education Support"
                    }), e.jsx("p", {
                        className: "text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl",
                        children: "Our comprehensive education support program addresses every barrier that prevents vulnerable children from accessing quality education. From school fees to essential materials, we ensure that financial constraints never stand between a child and their dreams."
                    })]
                }), e.jsx("div", {
                    className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8",
                    children: l.map( (s, a) => e.jsxs("div", {
                        ...
                        children: [e.jsx("div", {
                            className: "w-10 h-10 sm:w-12 sm:h-12 bg-teal-600 rounded-lg flex items-center justify-center mb-4 sm:mb-6",
                            children: e.jsx("i", {
                                className: `${s.icon} text-xl sm:text-2xl text-white`
                            })
                        }), e.jsx("h3", {
                            ...
                            children: s.items.map( (r, n) => e.jsxs("li", {
                                className: "flex items-start gap-2 text-gray-700",
                                children: [e.jsx("i", {
                                    className: "ri-check-line text-teal-600 mt-1 flex-shrink-0 text-sm sm:text-base"
                                }), e.jsx("span", {
                            ...
                            children: e.jsx("p", {
                                className: "text-xs sm:text-sm font-semibold text-teal-700",
                                children: s.impact
                            })
                        })]
                    }, a))
                    ...
                    children: e.jsx(t, {
                        ...
                        children: "Support Education Programs"
                    })
                })]
            })
        }), e.jsx("section", {
            id: "events",
            className: "py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-teal-600 to-teal-700",
            children: e.jsx("div", {
                className: "max-w-7xl mx-auto",
                children: e.jsxs("div", {
                    className: "grid lg:grid-cols-5 gap-8 sm:gap-12",
                    children: [e.jsx("div", {
                        ...
                        children: e.jsxs("div", {
                            ...
                            children: [e.jsx("h2", {
                                ...
                                children: "Educate an Orphan Run"
                            }), e.jsx("p", {
                                className: "text-base sm:text-lg md:text-xl text-teal-100 mb-6 sm:mb-8 leading-relaxed",
                                children: "Our annual flagship fundraising event brings together runners, walkers, and supporters from across Uganda and beyond. Every step taken is a step toward educational opportunity for vulnerable children."
                            }), e.jsxs("div", {
                                className: "space-y-3 sm:space-y-4 mb-8 sm:mb-10",
                                children: [e.jsxs("div", {
                                    className: "flex items-center gap-3 sm:gap-4",
                                    children: [e.jsx("div", {
                                        className: "px-3 sm:px-4 py-1.5 sm:py-2 bg-white/20 rounded-full",
                                        children: e.jsx("span", {
                        ...
                        children: e.jsx("div", {
                            ...
                            children: i.map( (s, a) => e.jsxs("div", {
                                ...
                                children: [e.jsx("div", {
                                    ...
                                    className: "absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4 sm:p-6",
                                    children: e.jsxs("div", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("h2", {
                        className: "text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6",
                        children: "Our Vision: A School of Our Own"
                    }), e.jsx("p", {
                        className: "text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto",
                        children: "We envision owning and operating a model school that provides world-class education to vulnerable children while serving as a training ground for innovative teaching methods across Uganda."
                    })]
                }), e.jsxs("div", {
                    className: "mb-12 sm:mb-16",
                    children: [e.jsx("div", {
                        className: "bg-gray-100 rounded-full h-5 sm:h-6 overflow-hidden mb-3 sm:mb-4",
                        children: e.jsx("div", {
                        ...
                        children: [e.jsx("span", {
                            ...
                            children: "Target: UGX 2.5 Billion"
                        })]
                    })]
                }), e.jsxs("div", {
                    ...
                    children: [e.jsxs("div", {
                        ...
                        children: [e.jsx("div", {
                            ...
                            children: e.jsx("i", {
                                className: "ri-checkbox-circle-line text-2xl sm:text-3xl text-white"
                            })
                        }), e.jsx("h3", {
                            className: "text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4",
                            children: "Current Status"
                        }), e.jsxs("ul", {
                            className: "space-y-2 sm:space-y-3 text-gray-700 mb-4 sm:mb-6",
                            children: [e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                    className: "ri-check-line text-teal-600 mt-1 flex-shrink-0"
                                }), e.jsx("span", {
                                    children: "Land acquired (5 acres)"
                                })]
                            }), e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                    ...
                                    children: "Architectural plans completed"
                                })]
                            }), e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                    ...
                                    children: "Government approvals secured"
                                })]
                            }), e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                    ...
                                    children: "Foundation work begun"
                                })]
                            })]
                        })]
                    }), e.jsxs("div", {
                        ...
                        children: [e.jsx("div", {
                            ...
                            children: e.jsx("i", {
                                className: "ri-roadster-line text-2xl sm:text-3xl text-white"
                            })
                        }), e.jsx("h3", {
                            className: "text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4",
                            children: "Next Steps"
                            ...
                            children: [e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                    className: "ri-arrow-right-line text-amber-600 mt-1 flex-shrink-0"
                                }), e.jsx("span", {
                                    children: "Complete classroom blocks"
                                })]
                            }), e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                    ...
                                    children: "Install water and sanitation"
                                })]
                            }), e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                    ...
                                    children: "Build library and computer lab"
                                })]
                            }), e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                    ...
                                    children: "Recruit qualified teachers"
                                })]
                            })]
                        })]
                    }), e.jsxs("div", {
                        ...
                        children: [e.jsx("div", {
                            ...
                            children: e.jsx("i", {
                                className: "ri-hand-heart-line text-2xl sm:text-3xl text-white"
                            })
                        }), e.jsx("h3", {
                            className: "text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4",
                            ...
                            children: [e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                    className: "ri-heart-line text-gray-600 mt-1 flex-shrink-0"
                                }), e.jsx("span", {
                                    children: "Make a one-time donation"
                                })]
                            }), e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                    ...
                                    children: "Become a monthly supporter"
                                })]
                            }), e.jsxs("li", {
                                className: "flex items-start gap-2 text-sm sm:text-base",
                                children: [e.jsx("i", {
                                ...
                                children: [e.jsx("i", {
                                    ...
                                    children: "Partner with your company"
                                })]
                            })]
                        }), e.jsx(t, {
                            to: "/donate",
            ...
            className: "py-16 sm:py-24 px-4 sm:px-6 bg-gray-900",
            children: e.jsxs("div", {
                className: "max-w-4xl mx-auto text-center",
                children: [e.jsx("h2", {
                    className: "text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6",
                    children: "Transform Lives Through Education"
                }), e.jsx("p", {
                    className: "text-base sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-12 leading-relaxed",
                    children: "Your support makes all of these programs possible. Join us in creating lasting change."
                }), e.jsxs("div", {
...
export {d as default};
//# sourceMappingURL=page-Da9iOWy6.js.map
