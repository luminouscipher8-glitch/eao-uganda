import {j as e, L as i} from "./index-CWbBFHrl.js";
function d() {
    const l = [{
        ...
        children: [e.jsx("section", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: "Give Stock & Securities"
                }), e.jsx("p", {
                    className: "text-lg sm:text-xl md:text-2xl text-teal-100 mb-8 sm:mb-12 max-w-3xl leading-relaxed",
                    children: "Maximize your impact and tax benefits by donating appreciated stocks and securities"
                }), e.jsxs("div", {
                    ...
                    children: [e.jsxs("div", {
                        ...
                        children: [e.jsx("div", {
                            ...
                            className: "text-sm sm:text-base text-teal-100",
                            children: "Market Value Deduction"
                        })]
                    }), e.jsxs("div", {
                        className: "bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/20",
                        children: [e.jsx("div", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("h2", {
                        ...
                        children: "Why Donate Securities?"
                    }), e.jsx("p", {
                        className: "text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed",
                        children: "Giving stock is one of the most tax-efficient ways to support our mission"
                    })]
                }), e.jsx("div", {
                    className: "grid sm:grid-cols-2 gap-6 sm:gap-8",
                    children: l.map( (t, a) => e.jsxs("div", {
                        ...
                        children: [e.jsx("div", {
                            ...
                            children: e.jsx("i", {
                                className: `${t.icon} text-2xl sm:text-3xl text-teal-600`
                            })
                        }), e.jsx("h3", {
                            ...
                            className: "bg-teal-50 rounded-lg p-3 sm:p-4 border border-teal-200",
                            children: e.jsxs("p", {
                                className: "text-xs sm:text-sm text-teal-800 font-semibold",
                                children: ["Example: ", t.example]
                            })
                        })]
                    }, a))
                })]
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("h2", {
                        className: "text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6",
                        children: "Stock vs. Cash Comparison"
                    }), e.jsx("p", {
                        className: "text-base sm:text-lg md:text-xl text-gray-600",
                        children: "See the difference in tax efficiency when donating appreciated stock"
                    })]
                }), e.jsx("div", {
                    className: "bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-xl border-2 border-gray-200",
                    children: e.jsx("div", {
                        ...
                        children: e.jsxs("table", {
                            ...
                            children: [e.jsx("thead", {
                                ...
                                children: e.jsxs("tr", {
                                    children: [e.jsx("th", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-left text-sm sm:text-base font-bold",
                                        children: "Scenario"
                                    }), e.jsx("th", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base font-bold",
                                        children: "Cash Gift"
                                    }), e.jsx("th", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base font-bold bg-amber-500",
                                        children: "Stock Gift ⭐"
                                    })]
                                })
                            }), e.jsxs("tbody", {
                                ...
                                children: [e.jsxs("tr", {
                                    ...
                                    children: [e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-sm sm:text-base font-semibold text-gray-900",
                                        children: "Gift Amount"
                                    }), e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base text-gray-700",
                                        children: s.cashGift.amount
                                    }), e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base text-gray-700 bg-amber-50",
                                        children: s.stockGift.amount
                                    })]
                                }), e.jsxs("tr", {
                                    className: "hover:bg-gray-50",
                                    children: [e.jsx("td", {
                                        ...
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base text-gray-700",
                                        children: s.cashGift.capitalGains
                                    }), e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base font-bold text-green-600 bg-amber-50",
                                        children: s.stockGift.capitalGains
                                    })]
                                }), e.jsxs("tr", {
                                    className: "hover:bg-gray-50",
                                    children: [e.jsx("td", {
                                        ...
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base text-gray-700",
                                        children: s.cashGift.taxDeduction
                                    }), e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base text-gray-700 bg-amber-50",
                                        children: s.stockGift.taxDeduction
                                    })]
                                }), e.jsxs("tr", {
                                    className: "hover:bg-gray-50 bg-teal-50",
                                    children: [e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-sm sm:text-base font-bold text-gray-900",
                                        children: "Net Cost to You"
                                    }), e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-base sm:text-lg font-bold text-gray-900",
                                        children: s.cashGift.netCost
                                    }), e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-base sm:text-lg font-bold text-green-600 bg-amber-100",
                                        children: s.stockGift.netCost
                                    })]
                                }), e.jsxs("tr", {
                                    className: "hover:bg-gray-50 bg-teal-50",
                                    children: [e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-sm sm:text-base font-bold text-gray-900",
                                        children: "Amount to Charity"
                                    }), e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-base sm:text-lg font-bold text-gray-900",
                                        children: s.cashGift.toCharity
                                    }), e.jsx("td", {
                                        className: "px-4 sm:px-6 py-4 sm:py-5 text-center text-base sm:text-lg font-bold text-teal-600 bg-amber-100",
                                        children: s.stockGift.toCharity
                                    })]
                                })]
                            })]
                        })
                    ...
                    className: "mt-6 sm:mt-8 bg-amber-100 border-2 border-amber-300 rounded-xl sm:rounded-2xl p-6 sm:p-8",
                    children: e.jsxs("div", {
                        className: "flex items-start gap-3 sm:gap-4",
                        children: [e.jsx("i", {
                            className: "ri-lightbulb-flash-line text-2xl sm:text-3xl text-amber-600 mt-1 flex-shrink-0"
                        }), e.jsxs("div", {
                            children: [e.jsx("h4", {
                                ...
                                children: ["By donating stock instead of cash, you save ", e.jsx("strong", {
                                    className: "text-amber-600",
                                    children: "UGX 1,500,000"
                                }), " in taxes while still giving ", e.jsx("strong", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("h2", {
                        ...
                        className: "text-base sm:text-lg md:text-xl text-gray-600",
                        children: "We can receive a wide range of marketable securities"
                    })]
                }), e.jsx("div", {
                    className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8",
                    children: r.map( (t, a) => e.jsxs("div", {
                        className: "bg-gray-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 border-2 border-gray-200 hover:border-teal-600 hover:shadow-xl transition-all duration-300",
                        children: [e.jsx("div", {
                            className: "w-12 h-12 sm:w-14 sm:h-14 bg-teal-600 rounded-lg flex items-center justify-center mb-4 sm:mb-6",
                            children: e.jsx("i", {
                            ...
                            className: "mb-4 sm:mb-6 space-y-1.5",
                            children: t.examples.map( (m, o) => e.jsxs("div", {
                            ...
                            className: "text-xs sm:text-sm text-teal-600 font-semibold",
            ...
            className: "py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-teal-600",
            children: e.jsxs("div", {
                className: "max-w-6xl mx-auto",
                children: [e.jsxs("div", {
                    className: "text-center mb-12 sm:mb-16",
                    children: [e.jsx("h2", {
                        ...
                        children: "How to Donate Securities"
                    }), e.jsx("p", {
                        className: "text-base sm:text-lg md:text-xl text-teal-100",
                        children: "Four simple steps to make your gift"
                    })]
                }), e.jsx("div", {
                    className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8",
                    children: x.map( (t, a) => e.jsxs("div", {
                        className: "bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-white/20",
                        children: [e.jsx("div", {
                            className: "text-5xl sm:text-6xl font-bold text-white/30 mb-4",
                            children: t.number
                        }), e.jsx("h3", {
                            className: "text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4",
                            children: t.title
                        }), e.jsx("p", {
                            className: "text-sm sm:text-base text-teal-100 mb-4 sm:mb-6 leading-relaxed",
                            children: t.description
                        }), e.jsxs("div", {
                            className: "text-xs sm:text-sm text-white font-semibold flex items-center gap-2",
                            children: [e.jsx("i", {
                    ...
                    children: e.jsx(i, {
                        ...
                        children: "Get Transfer Instructions"
                    })
                })]
            })
        }), e.jsx("section", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("h2", {
                        ...
                        className: "text-base sm:text-lg md:text-xl text-gray-600",
                        children: "Everything you need to know about donating securities"
                    })]
                }), e.jsx("div", {
                    className: "space-y-4 sm:space-y-6",
                    children: n.map( (t, a) => e.jsxs("div", {
                        ...
                        children: [e.jsxs("h3", {
                            ...
                            children: [e.jsx("i", {
                                className: "ri-question-line text-xl sm:text-2xl text-teal-600 mt-0.5 flex-shrink-0"
                            }), t.question]
                        }), e.jsx("p", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsx("h2", {
                    className: "text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6",
                    children: "Ready to Make Your Gift?"
                }), e.jsx("p", {
                    className: "text-base sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-12 leading-relaxed",
                    children: "Contact us today to get started with your stock donation"
                }), e.jsxs("div", {
                    ...
                    children: [e.jsx(i, {
                        ...
                        children: "Contact Development Team"
                    }), e.jsx("a", {
                        href: "#",
...
export {d as default};
//# sourceMappingURL=page-BPbbsNzR.js.map
