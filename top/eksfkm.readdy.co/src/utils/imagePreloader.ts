...
export function generateSrcSet(src: string, breakpoints: number[] = IMAGE_BREAKPOINTS): string {
  return breakpoints
    .map(breakpoint => {
...
export function generateSizes(breakpoints: number[] = IMAGE_BREAKPOINTS): string {
  return breakpoints
