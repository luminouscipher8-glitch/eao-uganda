...
describe('useKeyboardNavigation', () => {
  ...
  it('should call onEscape when Escape key is pressed', () => {
    ...
    renderHook(() => useKeyboardNavigation({ current: mockElement }, { onEscape }))
  ...
  it('should call onEnter when Enter key is pressed', () => {
    ...
    renderHook(() => useKeyboardNavigation({ current: mockElement }, { onEnter }))
  ...
  it('should call onArrowUp when ArrowUp key is pressed', () => {
    ...
    renderHook(() => useKeyboardNavigation({ current: mockElement }, { onArrowUp }))
  ...
  it('should call onArrowDown when ArrowDown key is pressed', () => {
    ...
    renderHook(() => useKeyboardNavigation({ current: mockElement }, { onArrowDown }))
  ...
  it('should call onTab when Tab key is pressed', () => {
    ...
    renderHook(() => useKeyboardNavigation({ current: mockElement }, { onTab }))
  ...
  it('should call onShiftTab when Shift+Tab is pressed', () => {
    ...
    renderHook(() => useKeyboardNavigation({ current: mockElement }, { onShiftTab }))
  ...
  it('should not call handlers when disabled', () => {
    ...
    renderHook(() => useKeyboardNavigation({ current: mockElement }, { onEscape, enabled: false }))
  ...
  it('should cleanup event listener on unmount', () => {
    ...
    const { unmount } = renderHook(() => useKeyboardNavigation({ current: mockElement }, {}))
