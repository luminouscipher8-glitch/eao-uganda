...
export default function ProgramsPage() {
  ...
  const searchedStories = searchQuery
    ? filteredStories.filter(
        story =>
          ...
          story.impact.toLowerCase().includes(searchQuery.toLowerCase())
      )
    : filteredStories;
  ...
  const filters = [
    ...
    { id: 'education', label: 'Education Success', icon: 'ri-book-line' },
    { id: 'community', label: 'Community Impact', icon: 'ri-heart-line' },
    { id: 'volunteer', label: 'Volunteer Stories', icon: 'ri-user-heart-line' },
  ];
  ...
  const eventGallery = [
    {
      ...
      raised: 'UGX 45M',
      image:
        'https://public.readdy.ai/ai/img_res/a5c06f7bdd7e432e599ac1ef54d09652.jpg',
    },
    {
    ...
    },
    {
      ...
      raised: 'UGX 25M',
      image:
        'https://readdy.ai/api/search-image?query=professional%20corporate%20partnership%20event%20in%20Uganda%2C%20business%20people%20and%20community%20leaders%20networking%2C%20formal%20outdoor%20setting%20with%20branded%20materials%2C%20handshakes%20and%20collaboration%2C%20professional%20event%20photography%20showing%20partnership%20building&width=600&height=400&seq=event-gallery-004&orientation=landscape',
    },
  ];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl">
                Our comprehensive education support program addresses every
                barrier that prevents vulnerable children from accessing quality
                education. From school fees to essential materials, we ensure
                that financial constraints never stand between a child and their
                dreams.
              </p>
            </div>
              ...
              {educationServices.map((service, index) => (
                ...
                >
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-teal-600 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
                    <i
                      className={`${service.icon} text-xl sm:text-2xl text-white`}
                    ></i>
                  </div>
              ...
              <div className="lg:col-span-2">
                <div className="lg:sticky lg:top-24">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6">
                    Educate an Orphan Run
                  </h2>
                  <p className="text-base sm:text-lg md:text-xl text-teal-100 mb-6 sm:mb-8 leading-relaxed">
                    Our annual flagship fundraising event brings together
                    runners, walkers, and supporters from across Uganda and
                    beyond. Every step taken is a step toward educational
                  ...
                  <div className="space-y-3 sm:space-y-4 mb-8 sm:mb-10">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <span className="text-sm sm:text-base text-teal-100">
        ...
        >
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">
                Our Vision: A School of Our Own
              </h2>
              <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto">
                We envision owning and operating a model school that provides
                world-class education to vulnerable children while serving as a
                training ground for innovative teaching methods across Uganda.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Real lives transformed through education and community support
              </p>
            </div>
              ...
              <div className="inline-flex bg-white rounded-full p-1 shadow-md border border-gray-200">
                {filters.map(filter => (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 rounded-full text-sm sm:text-base font-semibold transition-all duration-300 whitespace-nowrap cursor-pointer ${
                ...
                >
                  ...
                  <div className="p-6 sm:p-8">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-xs sm:text-sm font-semibold">
                        {story.category === 'education' && 'Education'}
                        {story.category === 'community' && 'Community'}
                        {story.category === 'volunteer' && 'Volunteer'}
                      </div>
                    </div>
            ...
            <div className="text-center mt-12 sm:mt-16">
              {searchedStories.length > 3 && (
                ...
                >
                  View All Stories ({searchedStories.length} total)
                </button>
              )}
              <Link
                to="/donate"
                ...
                <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
                  <div className="p-6 border-b border-gray-200">
                    ...
                    <div className="relative">
                      <input
                        type="text"
                        placeholder="Search stories by name, story, or impact..."
                        value={searchQuery}
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gray-900">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-12 leading-relaxed">
              Your support makes all of these programs possible. Join us in
