  ...
  const givingOptions = [
    {
      ...
      description:
        'Leave a lasting legacy by including Educate An Orphan in your will or trust',
      benefits: [
      ...
      howItWorks:
        'Include specific language in your will designating Educate An Orphan as a beneficiary. You can leave a specific amount, percentage of your estate, or remainder after other bequests.',
      sampleLanguage:
        'I give and bequeath to Educate An Orphan, Uganda (NGO Registration #12345), the sum of [amount] or [percentage]% of my estate to be used for its general charitable purposes.',
    },
    {
      id: 'life-insurance',
      ...
      icon: 'ri-shield-line',
      description:
        'Name Educate An Orphan as a beneficiary of your life insurance policy',
      benefits: [
      ...
      howItWorks:
        'Contact your insurance provider to name Educate An Orphan as a primary or contingent beneficiary. You can designate a percentage or specific amount.',
      sampleLanguage:
        'Contact your insurance provider and request a beneficiary designation form. Complete it naming Educate An Orphan as beneficiary with our official registration details.',
    },
    {
      ...
      description:
        'Donate retirement fund assets like pension plans or provident funds',
      benefits: [
      ...
      howItWorks:
        'Complete a beneficiary designation form from your retirement plan administrator naming Educate An Orphan. Consult with your financial advisor for tax implications.',
      sampleLanguage:
        'Request a beneficiary designation form from your retirement plan administrator. Designate Educate An Orphan as beneficiary for a specific percentage or the remainder.',
    },
    {
      id: 'charitable-trust',
      ...
      description:
        'Establish a charitable trust that benefits both you and our mission',
      benefits: [
      ...
      howItWorks:
        'Work with an attorney to establish a Charitable Remainder Trust (CRT) or Charitable Lead Trust (CLT). Assets are transferred to the trust, which pays income to you or your beneficiaries.',
      sampleLanguage:
        'Consult with an estate planning attorney to draft trust documents. The trust can be funded with cash, securities, real estate, or other assets.',
    },
  ];
  ...
  const legacyCircle = [
    {
      ...
      quote:
        "After 40 years in education, I want my legacy to continue helping children long after I'm gone.",
      image:
        'https://public.readdy.ai/ai/img_res/20829dd1b56987778839673f036c3c1a.jpg',
    },
    {
      ...
      quote:
        "We built our business to create opportunities. Now we're creating opportunities for children through our gift.",
      image:
        'https://readdy.ai/api/search-image?query=professional%20African%20couple%20business%20owners%20warm%20friendly%20smiles%20formal%20attire%20studio%20portrait%20soft%20lighting%20simple%20background&width=400&height=400&seq=legacy-002&orientation=squarish',
    },
    {
      ...
      quote:
        'This allows me to support my family while ensuring education remains accessible to vulnerable children.',
      image:
        'https://readdy.ai/api/search-image?query=distinguished%20elderly%20African%20professor%20intellectual%20warm%20expression%20formal%20portrait%20studio%20lighting%20simple%20background%20dignified%20presence&width=400&height=400&seq=legacy-003&orientation=squarish',
    },
  ];
  ...
  const steps = [
    {
      ...
      description:
        'Review the planned giving options and consider which aligns with your financial goals',
      icon: 'ri-search-line',
    },
    {
      number: '02',
      ...
      description:
        'Speak with your financial advisor, attorney, or tax professional about the best approach',
    ...
    },
    {
      ...
      description:
        'Reach out to our planned giving coordinator for information and sample language',
      icon: 'ri-phone-line',
    },
    {
      number: '04',
      ...
      description:
        'Complete necessary documentation and inform us so we can thank you properly',
  ...
  const faqs = [
    {
      ...
      answer:
        "No, planned gifts are designed to work with your financial goals. Most options cost you nothing during your lifetime and can actually provide income or tax benefits while you're living.",
    },
    {
      question: 'Can I change my mind after making a planned gift commitment?',
      answer:
        'Yes, most planned gifts (like bequests and beneficiary designations) can be modified or revoked if your circumstances change. This flexibility is one of the main advantages of planned giving.',
    },
    {
      question: 'How much do I need to give to make a planned gift?',
      answer:
        'There is no minimum amount. Any planned gift, regardless of size, makes a meaningful difference and helps us plan for the future.',
    },
    {
      question: 'Will my family be informed of my planned gift?',
      answer:
        "That's entirely up to you. We recommend discussing major estate decisions with family, but you control what information is shared. We respect your privacy completely.",
    },
    {
      question: 'What are the tax benefits of planned giving?',
      answer:
        'Benefits vary by gift type and include estate tax reductions, income tax deductions, capital gains tax avoidance, and more. Consult with your tax advisor for specific guidance.',
    },
  ];

  const selectedGivingOption = givingOptions.find(
        ...
        <section className="relative py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-gradient-to-br from-amber-600 via-amber-700 to-amber-800">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-amber-100 mb-8 sm:mb-12 max-w-3xl leading-relaxed">
              Create meaningful change that extends beyond your lifetime through
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Choose the approach that best fits your financial situation and
                philanthropic goals
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16">
              {givingOptions.map(option => (
                ...
                >
                  <div
                    className={`w-12 h-12 sm:w-14 sm:h-14 ${selectedOption === option.id ? 'bg-amber-600' : 'bg-gray-100'} rounded-lg flex items-center justify-center mb-3 sm:mb-4`}
                  >
                    <i
                      className={`${option.icon} text-2xl sm:text-3xl ${selectedOption === option.id ? 'text-white' : 'text-gray-600'}`}
                    ></i>
                  </div>
              ...
              <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-8 sm:p-12 border-2 border-gray-200">
                <div className="flex items-start gap-4 sm:gap-6 mb-6 sm:mb-8">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-amber-600 rounded-xl flex items-center justify-center flex-shrink-0">
                    <i
                      className={`${selectedGivingOption.icon} text-3xl sm:text-4xl text-white`}
                    ></i>
                  </div>
                  <div>
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2 sm:mb-3">
                      {selectedGivingOption.title}
                    </h3>
                    <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed">
                      {selectedGivingOption.description}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 sm:gap-12 mb-8 sm:mb-12">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-6 sm:mb-8">
                      {selectedGivingOption.howItWorks}
                    </p>
                    ...
                    <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 border border-amber-200">
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 italic leading-relaxed">
                        {selectedGivingOption.sampleLanguage}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-600">
                Meet donors who are creating lasting impact through planned
                giving
              </p>
            </div>
              ...
              {legacyCircle.map((member, index) => (
                ...
                >
                  ...
                  <div className="p-6 sm:p-8">
                    ...
                    <p className="text-sm sm:text-base text-amber-600 font-semibold mb-1">
                      {member.profession}
                    </p>
              ...
              {steps.map((step, index) => (
                <div key={index} className="relative">
                  <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 border-2 border-gray-200 hover:border-amber-600 hover:shadow-xl transition-all duration-300">
                    <div className="text-5xl sm:text-6xl font-bold text-amber-100 mb-4">
                      {step.number}
                    </div>
                    <div className="w-12 h-12 sm:w-14 sm:h-14 bg-amber-600 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
                      <i
                        className={`${step.icon} text-2xl sm:text-3xl text-white`}
                      ></i>
                    </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed pl-8 sm:pl-11">
                    {faq.answer}
                  </p>
                </div>
              ))}
        ...
        <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-gray-900">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-12 leading-relaxed">
              Contact our planned giving coordinator for a confidential,
