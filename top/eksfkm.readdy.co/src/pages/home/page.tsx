...
import { Counter, SlideIn, FadeIn } from '../../components/common/MicroInteractions';
        ...
        <div className="relative h-full flex items-center justify-center px-4 sm:px-6">
          <div className="max-w-4xl text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white/90 mb-8 sm:mb-12 font-light max-w-3xl mx-auto leading-relaxed px-4">
              Every child deserves the opportunity to learn, grow, and transform their community through quality education
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 sm:gap-16">
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                To provide comprehensive educational support to orphaned and vulnerable children in Uganda, ensuring they have access to quality education, essential school materials, and the resources needed to build a brighter future for themselves and their communities.
              </p>
            </div>
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                A Uganda where every child, regardless of their circumstances, has equal access to quality education and the opportunity to reach their full potential, breaking the cycle of poverty through knowledge and empowerment.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="text-center max-w-lg w-full">
              ...
              <FadeIn delay={400}>
                <div className="text-2xl sm:text-3xl uppercase tracking-wider text-teal-200">
                  Across <Counter end={12} duration={1500} delay={700} /> Districts
                </div>
              </FadeIn>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-12 max-w-xl w-full">
              <SlideIn direction="up" delay={600}>
                <div className="text-center w-16">
                  ...
                  <div className="text-xs sm:text-sm uppercase tracking-wider text-teal-600">Years of Service</div>
                </div>
              </SlideIn>
              <SlideIn direction="up" delay={800}>
                <div className="text-center w-24">
                  <div className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-teal-700 mb-2 sm:mb-3">
                    <Counter end={94} duration={1200} delay={1000} suffix="%" />
                  </div>
                  <div className="text-xs sm:text-sm uppercase tracking-wider text-teal-600">Transparency Score</div>
                </div>
              </SlideIn>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 sm:mb-16">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xs sm:text-sm uppercase tracking-wider text-amber-600 font-semibold">What We Do</span>
            </div>
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed flex items-center">
                We provide comprehensive support programs that address the educational needs of orphaned and vulnerable children across Uganda, from school fees to essential materials and beyond.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <Link to="/programs#education" className="group relative h-80 sm:h-96 rounded-2xl sm:rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-102 cursor-pointer">
              <OptimizedImage
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 text-white">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-3">Education Support</h3>
                <p className="text-sm sm:text-base text-white/90 mb-3 sm:mb-4 leading-relaxed">School fees, scholastic materials, uniforms, and sanitary support for vulnerable children</p>
            ...
            {/* Runs & Events Card */}
            <Link to="/programs#events" className="group relative h-80 sm:h-96 rounded-2xl sm:rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-102 cursor-pointer">
              <OptimizedImage
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 text-white">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-3">Runs & Events</h3>
                <p className="text-sm sm:text-base text-white/90 mb-3 sm:mb-4 leading-relaxed">Annual fundraising runs and community events that bring people together for education</p>
            ...
            <Link to="/programs#school-building" className="group relative h-80 sm:h-96 rounded-2xl sm:rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-102 cursor-pointer">
              <OptimizedImage
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 text-white">
                <div className="w-12 sm:w-16 h-1 bg-amber-500 mb-3 sm:mb-4"></div>
                <h3 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-3">School-Building Initiative</h3>
                <p className="text-sm sm:text-base text-white/90 mb-3 sm:mb-4 leading-relaxed">Our vision to own and operate a school that serves as a model for quality education</p>
                <span className="inline-flex items-center gap-2 text-amber-400 font-semibold group-hover:gap-4 transition-all text-sm sm:text-base">
                  Learn More <i className="ri-arrow-right-line"></i>
                </span>
              </div>
      ...
      <section className="relative py-20 sm:py-32 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-8 sm:p-12 md:p-16 text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-teal-700 mb-4 sm:mb-6">Every Child Deserves Education</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-700 mb-8 sm:mb-10 leading-relaxed max-w-2xl mx-auto">
              Your support can transform a child's life forever. Join us in building a brighter future for Uganda's most vulnerable children through the power of education.
            </p>
