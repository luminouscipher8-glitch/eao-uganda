  ...
  const partnershipModels = [
    {
      ...
      description: 'Annual or multi-year financial commitments that provide predictable funding for our programs',
      examples: ['Annual grants', 'Multi-year pledges', 'Endowment contributions']
    },
    {
      icon: 'ri-team-line',
      title: 'Employee Matching',
      description: 'Match employee donations dollar-for-dollar to multiply impact and engage your workforce',
      examples: ['Payroll giving programs', 'Volunteer hour matching', 'Campaign matching']
    },
    {
      icon: 'ri-briefcase-line',
      title: 'In-Kind Contributions',
      description: 'Donate products, services, or expertise that directly support our operations',
      examples: ['School supplies', 'Professional services', 'Technology donations']
    },
    {
      icon: 'ri-heart-line',
      title: 'Cause Marketing',
      description: 'Partner on campaigns where a portion of sales supports our mission',
      examples: ['Product partnerships', 'Awareness campaigns', 'Co-branded initiatives']
    }
  ];
  ...
  const benefits = [
    {
      ...
      description: 'Associate your brand with meaningful social impact and community development'
    },
    {
      icon: 'ri-team-line',
      title: 'Employee Engagement',
      description: 'Boost morale and retention through purposeful volunteer opportunities'
    },
    {
      icon: 'ri-trophy-line',
      title: 'CSR Recognition',
      description: 'Demonstrate corporate social responsibility with measurable impact'
    },
    {
      icon: 'ri-shield-check-line',
      title: 'Tax Benefits',
      description: 'Receive tax deductions for charitable contributions as per Uganda tax law'
    }
  ];
    ...
    <div className="pt-16 md:pt-0">
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 sm:mb-6">Corporate Partnerships</h1>
          <p className="text-lg sm:text-xl md:text-2xl text-teal-100 mb-8 sm:mb-12 max-w-3xl leading-relaxed">
            Partner with us to create lasting impact while strengthening your corporate social responsibility initiatives
          </p>

          <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/20">
              <div className="text-3xl sm:text-4xl font-bold text-white mb-1 sm:mb-2">15+</div>
              <div className="text-sm sm:text-base text-teal-100">Corporate Partners</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/20">
              <div className="text-3xl sm:text-4xl font-bold text-white mb-1 sm:mb-2">UGX 180M</div>
              <div className="text-sm sm:text-base text-teal-100">Corporate Support 2023</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/20">
              <div className="text-3xl sm:text-4xl font-bold text-white mb-1 sm:mb-2">1,200+</div>
              <div className="text-sm sm:text-base text-teal-100">Employee Volunteers</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">Partnership Tiers</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Choose the level of engagement that aligns with your company's values and capacity
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            {sponsorshipTiers.map((tier) => (
              ...
              >
                <div className={`w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br ${tier.color} rounded-xl flex items-center justify-center mb-4 sm:mb-6`}>
                  <i className={`${tier.icon} text-2xl sm:text-3xl text-white`}></i>
                </div>
                
                <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">{tier.name}</h3>
                <div className="text-xl sm:text-2xl font-bold text-teal-600 mb-4 sm:mb-6">{tier.amount}</div>
                
                <div className="mb-4 sm:mb-6">
                  <p className="text-sm sm:text-base font-semibold text-amber-600 mb-3 sm:mb-4">{tier.impact}</p>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">Partnership Models</h2>
            ...
            {partnershipModels.map((model, index) => (
              ...
              >
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-teal-100 rounded-xl flex items-center justify-center mb-4 sm:mb-6">
                  <i className={`${model.icon} text-2xl sm:text-3xl text-teal-600`}></i>
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">{model.title}</h3>
                <p className="text-sm sm:text-base text-gray-700 mb-4 sm:mb-6 leading-relaxed">{model.description}</p>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">Our Corporate Partners</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600">
              ...
              >
                <div className="flex items-start justify-between mb-4 sm:mb-6">
                  <div className="h-16 sm:h-20 flex items-center">
                    <img src={partner.logo} alt={partner.name} className="max-h-full w-auto" />
                  </div>
                  <span className="px-3 sm:px-4 py-1 sm:py-1.5 bg-amber-100 text-amber-700 text-xs sm:text-sm font-semibold rounded-full">
                    {partner.tier}
                  </span>
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{partner.name}</h3>
                <p className="text-sm sm:text-base text-gray-600 mb-2">Partner since {partner.since}</p>
                <p className="text-sm sm:text-base text-gray-700 font-semibold">{partner.contribution}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-teal-600">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6">Benefits of Partnership</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-6 sm:p-8 border border-white/20">
                ...
                <p className="text-sm sm:text-base text-teal-100 leading-relaxed">{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">Ready to Partner?</h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 sm:mb-12 leading-relaxed">
            Let's discuss how your company can create meaningful impact while achieving your CSR goals
          </p>
