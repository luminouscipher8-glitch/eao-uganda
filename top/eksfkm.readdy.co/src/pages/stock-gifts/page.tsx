  ...
  const benefits = [
    {
      ...
      description:
        'Donating appreciated securities allows you to avoid paying capital gains tax on the appreciation',
      example:
        'If your stock increased UGX 10M, you save the 30% capital gains tax',
    },
    {
      icon: 'ri-money-dollar-circle-line',
      title: 'Full Market Value Deduction',
      description:
        'Receive a tax deduction for the full fair market value of the securities on the date of transfer',
    ...
    },
    {
      ...
      description:
        'By avoiding capital gains tax, you can give more to the cause you care about',
    ...
    },
    {
      ...
      description:
        'Transfer securities directly from your brokerage account with minimal paperwork',
  ...
  const steps = [
    {
      ...
      title: 'Contact Us',
      description:
        'Reach out to our development team to express your interest in donating securities',
    ...
    },
    {
      ...
      description:
        "We'll provide you with our brokerage account information and transfer instructions",
    ...
    },
    {
      ...
      description:
        'Contact your broker to initiate an electronic transfer of the securities to our account',
    ...
    },
    {
      ...
      description:
        "Once we receive the securities, we'll send you a receipt for tax purposes",
  ...
  const faqs = [
    {
      ...
      answer:
        "We accept publicly traded stocks, bonds, mutual funds, and other marketable securities. Contact us to discuss specific holdings you'd like to donate.",
    },
    {
      question: 'How long does the transfer take?',
      answer:
        'Electronic transfers typically take 3-5 business days. The timing may vary based on your broker and the type of securities.',
    },
    {
      question: 'When is my tax deduction calculated?',
      answer:
        'Your deduction is based on the fair market value of the securities on the date of transfer to our account, not when you initiate the transfer.',
    },
    {
      question: 'Can I donate securities held in a retirement account?',
      answer:
        'Yes, but special rules apply. We recommend consulting with your financial advisor to understand the best approach for your situation.',
    },
    {
      question: 'What if my stock has decreased in value?',
      answer:
        'If your securities have lost value, it may be better to sell them first, claim the capital loss, and then donate cash. Consult your tax advisor.',
    },
    {
      question: 'Will I receive documentation for my taxes?',
      answer:
        "Yes, we'll provide an acknowledgment letter stating the number of shares and date received. Your broker will provide cost basis information.",
    },
  ];
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="relative py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-gradient-to-br from-teal-600 via-teal-700 to-teal-800">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-teal-100 mb-8 sm:mb-12 max-w-3xl leading-relaxed">
              Maximize your impact and tax benefits by donating appreciated
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Giving stock is one of the most tax-efficient ways to support
                our mission
              </p>
            </div>
        ...
        <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-gray-50">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">
                Stock vs. Cash Comparison
              </h2>
              <p className="text-base sm:text-lg md:text-xl text-gray-600">
                See the difference in tax efficiency when donating appreciated
                stock
              </p>
            </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-teal-600 text-white">
                    <tr>
                      <th className="px-4 sm:px-6 py-4 sm:py-5 text-left text-sm sm:text-base font-bold">
                        Scenario
                      </th>
                      <th className="px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base font-bold">
                        Cash Gift
                      </th>
                      <th className="px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base font-bold bg-amber-500">
                        Stock Gift ⭐
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50">
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-sm sm:text-base font-semibold text-gray-900">
                        Gift Amount
                      </td>
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base text-gray-700">
                        {comparisonData.cashGift.amount}
                      </td>
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base text-gray-700 bg-amber-50">
                        {comparisonData.stockGift.amount}
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-sm sm:text-base font-semibold text-gray-900">
                      ...
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base text-gray-700">
                        {comparisonData.cashGift.capitalGains}
                      </td>
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base font-bold text-green-600 bg-amber-50">
                        {comparisonData.stockGift.capitalGains}
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-sm sm:text-base font-semibold text-gray-900">
                      ...
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base text-gray-700">
                        {comparisonData.cashGift.taxDeduction}
                      </td>
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-center text-sm sm:text-base text-gray-700 bg-amber-50">
                        {comparisonData.stockGift.taxDeduction}
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50 bg-teal-50">
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-sm sm:text-base font-bold text-gray-900">
                        Net Cost to You
                      </td>
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-center text-base sm:text-lg font-bold text-gray-900">
                        {comparisonData.cashGift.netCost}
                      </td>
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-center text-base sm:text-lg font-bold text-green-600 bg-amber-100">
                        {comparisonData.stockGift.netCost}
                      </td>
                    </tr>
                    <tr className="hover:bg-gray-50 bg-teal-50">
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-sm sm:text-base font-bold text-gray-900">
                      ...
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-center text-base sm:text-lg font-bold text-gray-900">
                        {comparisonData.cashGift.toCharity}
                      </td>
                      <td className="px-4 sm:px-6 py-4 sm:py-5 text-center text-base sm:text-lg font-bold text-teal-600 bg-amber-100">
                        {comparisonData.stockGift.toCharity}
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                    By donating stock instead of cash, you save{' '}
                    <strong className="text-amber-600">UGX 1,500,000</strong> in
                    taxes while still giving{' '}
                    <strong className="text-teal-600">UGX 5,000,000</strong> to
              ...
              {acceptedSecurities.map((security, index) => (
                ...
                >
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-teal-600 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
                    <i
                      className={`${security.icon} text-2xl sm:text-3xl text-white`}
                    ></i>
                  </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {steps.map((step, index) => (
                ...
                >
                  <div className="text-5xl sm:text-6xl font-bold text-white/30 mb-4">
                    {step.number}
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">
                    {step.title}
                  </h3>
                  <p className="text-sm sm:text-base text-teal-100 mb-4 sm:mb-6 leading-relaxed">
                    {step.description}
                  </p>
