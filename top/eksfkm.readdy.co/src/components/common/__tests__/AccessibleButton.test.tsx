...
describe('AccessibleButton', () => {
  ...
  it('renders as link when to prop is provided', () => {
    renderWithRouter(<AccessibleButton to="/test">Go to test</AccessibleButton>)
  ...
  it('applies aria-describedby correctly', () => {
    render(
      <div>
        ...
        <AccessibleButton ariaDescribedBy="description">Button</AccessibleButton>
      </div>
    )
  ...
  it('does not show icon when loading', () => {
    ...
    render(<AccessibleButton loading leftIcon={icon}>Loading</AccessibleButton>)
