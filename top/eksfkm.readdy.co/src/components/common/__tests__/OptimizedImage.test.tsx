...
describe('OptimizedImage', () => {
  ...
  it('shows loading skeleton initially', () => {
    ...
    expect(screen.getByRole('img').closest('div')?.querySelector('.loading-skeleton')).toBeInTheDocument()
  })
  ...
  it('applies custom className', () => {
    renderWithProvider(<OptimizedImage {...defaultProps} className="custom-class" />)
